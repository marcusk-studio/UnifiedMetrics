...
import dev.cubxity.plugins.metrics.tracing.otel.OtelTracingDriverFactory
...
abstract class CoreUnifiedMetricsPlugin : AbstractUnifiedMetricsPlugin() {
    ...
    override fun registerTracingDrivers() {
        apiProvider.tracingManager.apply {
            registerDriver("otel", OtelTracingDriverFactory)
        }
    }
}